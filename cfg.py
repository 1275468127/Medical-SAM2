...
def parse_args():    
    ...
    #parser.add_argument('-sam_ckpt', type=str, default="/data/hhb/project1/PS-SAM2/Medical-SAM2/logs/samba_train_test_2024_09_20_12_16_46/Model/latest_epoch.pth" , help='sam checkpoint address')
