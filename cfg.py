...
def parse_args():    
    ...
    parser.add_argument('-dataset', default="monuseg",type=str,help='dataset name')
    ...
    parser.add_argument('-sam_ckpt', type=str, default="/data/hhb/project1/PS-SAM2/Medical-SAM2/logs/samba_train_test_2024_10_07_10_21_25-monuseg-58.56/Model/base_aji_epoch.pth" , help='sam checkpoint address')
